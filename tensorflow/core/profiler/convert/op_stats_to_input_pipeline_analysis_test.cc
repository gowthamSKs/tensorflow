...
TEST(TfOpStatsToInputPipelineAnalysisTest,
  ...
  proto2::Map<std::string, uint64_t>& category_ps =
  ...
  proto2::Map<uint32_t, CoreDetails> core_details_map;
  ...
  const proto2::Map<std::string, uint64_t>& updated_category_ps =
...
TEST(TfOpStatsToInputPipelineAnalysisTest,
  ...
  tensorflow::profiler::PerCoreStepInfo* pcsi = step_db.add_step_sequence();
  pcsi->set_step_num(step_num);
  proto2::Map<uint32_t, tensorflow::profiler::StepInfoResult>& sipc_map =
  ...
  proto2::Map<std::string, uint64_t>& category_ps2 =
  ...
  const proto2::Map<std::string, uint64_t>& updated_category_ps2 =
